...
from monkeytype.typing import NoneType, NotImplementedType, is_typed_dict, mappingproxy, get_or_create_dynamic_type
...
def type_from_dict(d: TypeDict) -> type:
    ...
    elif module == "monkeytype.typing" and qualname.startswith("Array,"):
        return get_or_create_dynamic_type(qualname)
    else:
